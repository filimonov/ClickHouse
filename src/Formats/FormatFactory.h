...
public:
    ...
    BlockOutputStreamPtr getOutput(const String & name, WriteBuffer & buf,
        const Block & sample, const Context & context, WriteCallback callback = {}, const bool allow_multiple_rows_in_unframed_formats = false) const;
    ...
    OutputFormatPtr getOutputFormat(
        const String & name, WriteBuffer & buf, const Block & sample, const Context & context, WriteCallback callback = {}, const bool allow_multiple_rows_in_unframed_formats = false) const;
