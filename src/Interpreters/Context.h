...
public:
    ...
    const CustomVariablesDefinitionsDiskStorage & getCustomVariablesDefinitionsStorage() const;
    CustomVariablesDefinitionsDiskStorage & getCustomVariablesDefinitionsStorage();
