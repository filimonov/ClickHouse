...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(CREATE_VARIABLE, "", GLOBAL, CREATE) /* allows to execute CREATE VARIABLE */ \
    ...
    M(DROP_VARIABLE, "", GLOBAL, DROP) /* allows to execute DROP VARIABLE */\
    ...
    M(SHOW_CUSTOM_VARIABLES, "", GLOBAL, SHOW) /* allows to read system.custom_variables */\
    ...
    M(SYSTEM_CUSTOM_VARIABLES, "SYSTEM REFRESH VARIABLE, SYSTEM REFRESH REPLICATED VARIABLE, SYSTEM REFRESH VARIABLES", GLOBAL, SYSTEM) \
